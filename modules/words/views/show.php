...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('words/manage', 'View All Words', array("class" => "button alt"));
        echo anchor('words/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="record-details">
                <div class="row">
                    <div>Word Date</div>
                    <div><?= date('l jS F Y',  strtotime($word_date)) ?></div>
                </div>
                <div class="row">
                    <div>Word</div>
                    <div><?= $word ?></div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('words/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a word record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
