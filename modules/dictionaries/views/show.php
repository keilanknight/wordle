...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('dictionaries/manage', 'View All Dictionaries', array("class" => "button alt"));
        echo anchor('dictionaries/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('dictionaries/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a dictionary record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
